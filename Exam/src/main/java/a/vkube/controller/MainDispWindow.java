...
public class MainDispWindow {
    ...
    @FXML
    void getDriverAction(ActionEvent event) throws Exception{
        Parent root = FXMLLoader.load(getClass().getResource("/view/getDriver.fxml"));
        Stage stage = new Stage();
        stage.getIcons().add(new Image("/view/images/Icon.jpg"));
        stage.setTitle("Назначение водителя на заказ");
        stage.setScene(new Scene(root));
        stage.show();
    }
}